...
interface PozycjePaginationProps {
  totalCount: number;
  page: number;
  pageSize: number;
}

export function PozycjePagination({ totalCount, page, pageSize }: PozycjePaginationProps) {
  ...
  // Calculate which page numbers to show (max 5 with ellipsis)
